...
Widget buildLecturer(Lecturer lecturer){
  if (lecturer != null && lecturer.name != null) return Container(
    child: Row(
      children: <Widget>[
        Icon(Icons.person),
...
GestureDetector makeGestureDetector(LectureCard card, BuildContext context) => GestureDetector(
          ...
          Expanded(
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                    children: <Widget>[
                      Text(card.lecture, style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis,),
                      buildContent(card),
                    ]
                ),
              ],
...
List<LectureCard> lectureCards = [
  ...
  LectureCard(
    ...
    place: "Place 1",
    description: "Some description, and this one is a very long one, and it need to take fuul page\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nv\nthe end\n",
  ),
  LectureCard(
    lectureId: 3,
    startTime: "09:00",
  ...
  LectureCard(
    ...
    startTime: "11:00",
    endTime: "13:00",
    //lecture: "Lecture with along name, for test long name as it can be in the academy, with a few lins",
    lecture: "Lecture 3",
    lecturer: new Lecturer(name: "Lecturer 1"),
    place: "Place 1",
    description: "Some description",
